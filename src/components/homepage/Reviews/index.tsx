          ...
          <div className="relative flex items-end sm:items-center max-w-frame mx-auto mb-6 md:mb-10 px-4 xl:px-0">
            <motion.h2
              ...
              className={cn([
                ...
                "text-[32px] leading-[36px] md:text-4xl capitalize mr-auto",
              ])}
            >
              nuestros clientes
            </motion.h2>
            <div className="flex items-center space-x-1 ml-2">
              ...
              <Icon icon="formkit:arrowleft" width="42.67" height="24"></Icon>
              </CarouselPrevious>
              <CarouselNext variant="ghost" className="text-2xl">
              <Icon icon="formkit:arrowright" width="42.67" height="24"></Icon>
              </CarouselNext>
            </div>
          </div>
          <CarouselContent>
