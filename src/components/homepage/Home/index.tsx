    ...
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          <motion.h2
            ...
            className={cn([
              ...
              "text-4xl lg:text-5xl lg:leading-[64px] mb-5 lg:mb-8",
            ])}
          >
          ...
          >
            Descubre nuestro multimarket con productos de primera necesidad para toda la familia cubana. Calidad, variedad y los mejores precios.
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
            whileInView={{ y: "0", opacity: 1 }}
        ...
        >
          ...
          height={500}
            width={500}
            className="relative hidden md:block md:px-4 min-h-[448px] md:min-h-[428px] bg-cover"
          />
          <Image
          alt="banner"
          ...
          height={450}
            width={450}
            className="relative block md:hidden md:px-4 min-h-[448px] md:min-h-[428px] bg-cover"
          />
          <Image
            priority
